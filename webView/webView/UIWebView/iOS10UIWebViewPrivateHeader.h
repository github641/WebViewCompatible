 ...
 */
@interface UIWebView : UIView <NSCoding, UIScrollViewDelegate, WebPolicyDelegate> {// 多遵守了这个协议WebPolicyDelegate
...
@property (readonly, copy) NSString *debugDescription;// NSObject 方法/属性
@property (nonatomic) <UIWebViewDelegate> *delegate;
@property (readonly, copy) NSString *description;// NSObject 方法/属性
@property (nonatomic) bool detectsPhoneNumbers;
@property (nonatomic) double gapBetweenPages;
@property (readonly) unsigned long long hash;// NSObject 方法/属性
...
@property (readonly) Class superclass;// NSObject 方法/属性
@property (nonatomic) bool suppressesIncrementalRendering;
+ (void)_fixPathsForSandboxDirectoryChange;// 多了
+ (id)_relativePathFromAbsolutePath:(id)arg1 removingPathComponents:(unsigned long long)arg2;// 多了
+ (void)_updatePersistentStoragePaths;// 多了
+ (void)initialize;// NSObject 方法/属性
- (void)_addShortcut:(id)arg1;// 多了
- (bool)_allowsPictureInPictureVideo;
- (bool)_alwaysConstrainsScale;// 多了
- (bool)_alwaysDispatchesScrollEvents;// 多了
- (bool)_appliesExclusiveTouchToSubviewTree;// 多了
- (unsigned long long)_audioSessionCategoryOverride;// 多了
- (void)_beginRotation;// 多了
- (id)_browserView;// 多了
- (void)_define:(id)arg1;// 多了
- (void)_didCompleteScrolling;// 多了
- (void)_didRotate:(id)arg1;// 多了
- (id)_documentView;// 多了
- (void)_finishRotation;// 多了
- (void)_frameOrBoundsChanged;// 多了
- (double)_gapBetweenPages;// 多了
- (id)_initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 enableReachability:(bool)arg2;// 多了
- (id)_initWithWebView:(id)arg1;// 多了
- (id)_makeAlertView;// 多了
- (id)_networkInterfaceName;// 多了
- (unsigned long long)_pageCount;
- (double)_pageLength;
- (bool)_paginationBehavesLikeColumns;
- (long long)_paginationMode;
- (id)_pdfViewHandler;// 多了
- (void)_populateArchivedSubviews:(id)arg1;// 多了
- (Class)_printFormatterClass;// 多了
- (void)_reportError:(id)arg1;// 多了
- (void)_rescaleDocument;// 多了
- (id)_scrollView;
...
- (void)_setIsBlankBeforeFirstNonEmptyLayout:(bool)arg1;// 多了
- (void)_setNetworkInterfaceName:(id)arg1;// 多了
- (void)_setOverridesOrientationChangeEventHandling:(bool)arg1;// 多了
- (void)_setPageLength:(double)arg1;
- (void)_setPaginationBehavesLikeColumns:(bool)arg1;
- (void)_setPaginationMode:(long long)arg1;
- (void)_setRichTextReaderViewportSettings;// 多了
- (void)_setScalesPageToFitViewportSettings;
- (void)_setWebSelectionEnabled:(bool)arg1;// 多了
- (void)_share:(id)arg1;
- (void)_updateBrowserViewExposedScrollViewRect;// 多了
- (void)_updateCheckeredPattern;
- (void)_updateOpaqueAndBackgroundColor;
- (void)_updateRequest;
- (void)_updateScrollerViewForInputView:(id)arg1;
- (void)_updateViewSettings;
- (void)_webView:(id)arg1 commitPreview:(id)arg2;// 多了
- (void)_webView:(id)arg1 didDismissPreview:(id)arg2 committing:(bool)arg3;// 多了
- (id)_webView:(id)arg1 presentationRectsForPreview:(id)arg2;// 多了
- (id)_webView:(id)arg1 presentationSnapshotForPreview:(id)arg2;// 多了
- (bool)_webView:(id)arg1 previewIsAllowedForPosition:(struct CGPoint { double x1; double x2; })arg2;// 多了
- (id)_webView:(id)arg1 previewViewControllerForURL:(id)arg2;// 多了
- (void)_webView:(id)arg1 willPresentPreview:(id)arg2;// 多了 近几个应该是代理方法
...
- (void)copy:(id)arg1;
- (struct CGImage { }*)createSnapshotWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;// UIView方法
